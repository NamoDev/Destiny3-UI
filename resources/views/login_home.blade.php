...
<div class="row" style="margin-top:15px;">
    ...
    <div class="col-md-6">
        <div class="login-form">
            ...
            <a class="btn btn-primary btn-lg btn-block" href="#">สมัครใหม่</a>
        </div>
        <div class="login-form" style="margin-top:10px;">
            <legend>ปัญหาในการสมัคร?</legend>
            <div class="row">
                <div class="col-xs-6">
                    <a class="btn btn-primary btn-lg btn-block" href="#">คำถามที่พบบ่อย</a>
                </div>
                <div class="col-xs-6">
                    <a class="btn btn-primary btn-lg btn-block" href="#">ติดต่อเจ้าหน้าที่</a>
                </div>
            </div>
        </div>
    </div>
